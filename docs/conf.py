...
project = u'pytest-libtbx'
copyright = u'2015, Nicholas Devenish'
author = u'Nicholas Devenish'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-libtbx Documentation',
     [author], 1)
]
